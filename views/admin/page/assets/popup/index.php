<div class="action-bar clear">
	...
	<div class="action-menu helper-right">
		...
		<ul>
			<li><?php echo HTML::anchor('admin/assets/popup/upload', __('Upload asset'))?></li>
			<li><?php echo HTML::anchor('admin/assets/popup/delete', __('Delete assets'), array('id' => 'delete-assets'))?></li>
		</ul>
	</div>
	<h1>Assets</h1>
</div>
